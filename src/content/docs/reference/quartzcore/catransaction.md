...
本文非完整定义，完整版见[CATransaction](https://developer.apple.com/documentation/quartzcore/catransaction?language=objc)。

## 实例成员 (Instance members)

当前接口未暴露 `CATransaction` 的实例成员；默认直接使用其类成员 API。
